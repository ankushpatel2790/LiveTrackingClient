    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            scope.startObserve = function() {
                ...
                var uri = "api/clients/" + $routeParams.macaddress + scope.resource.path+"/observe";
                $http.post(uri, null)
                .success(function(data, status, headers, config) {
                    ...
                    errormessage = "Unable to start observation on resource " + scope.resource.path + " for "+ $routeParams.macaddress + " : " + status +" "+ data
            ...
            scope.stopObserve = function() {
                ...
                .success(function(data, status, headers, config) {
                    ...
                    errormessage = "Unable to stop observation on resource " + scope.resource.path + " for "+ $routeParams.macaddress + " : " + status +" "+ data
                    dialog.open(errormessage);
                    console.error(errormessage)
                });;
            };
            ...
            scope.read = function() {
                ...
                var uri = "api/clients/"+ scope.resource.path;
                $http.get(uri)
                .success(function(data, status, headers, config) {
                    ...
                    console.log("dfffff ------"+status);
                    
                    console.log("========="+"value" in data.content);
                    // manage read data
                    ...
                    errormessage = "Unable to read resource " + scope.resource.path + " for "+ $routeParams.macaddress + " : " + status +" "+ data
                    dialog.open(errormessage);
                    console.error(errormessage)
                });;
            };
            ...
            scope.write = function() {
                ...
                $('#writeSubmit').click(function(e){
                    ...
                    if(value != undefined) {
                        ...
                        var format = scope.settings.single.format;
                        $http({method: 'PUT', url: "api/clients/" +scope.resource.path+"/"+value, headers:{'Content-Type': 'application/json'}})
                        .success(function(data, status, headers, config) {
                            ...
                            errormessage = "Unable to write resource " + scope.resource.path + " for "+ $routeParams.macaddress + " : " + status +" "+ data
                            dialog.open(errormessage);
                            console.error(errormessage)
                        });;
                    }
            ...
            scope.exec = function() {
                $http.post("api/clients/" + $routeParams.macaddress+ scope.resource.path)
                .success(function(data, status, headers, config) {
                    ...
                    errormessage = "Unable to execute resource " + scope.resource.path + " for "+ $routeParams.macaddress + " : " + status +" "+ data
                    dialog.open(errormessage);
                    console.error(errormessage)
                });;
            };
            ...
            scope.execWithParams = function() {
                ...
                $('#writeSubmit').click(function(e){
                    ...
                    if(value) {
                        ...
                        $http({method: 'POST', url: "api/clients/" + $routeParams.macaddress + scope.resource.path, data: value})
                        .success(function(data, status, headers, config) {
